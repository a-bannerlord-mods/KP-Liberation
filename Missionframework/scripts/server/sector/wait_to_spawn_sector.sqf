...
sleep 0.1;
private _unitscount = [markerPos _sector, _corrected_size , GRLIB_side_friendly,_sector] call KPLIB_fnc_getUnitsCount;
...
_unitscount = [markerPos _sector, _corrected_size, GRLIB_side_friendly,_sector] call KPLIB_fnc_getUnitsCount;
