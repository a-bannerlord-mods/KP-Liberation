...
if ( (player isEqualTo ([] call KPLIB_fnc_getCommander) || player isEqualTo ([] call KPLIB_fnc_getCommandOfficer) || player isEqualTo ([] call KPLIB_fnc_getCommanderPlatoon)) && !(serverCommandAvailable "#kick")) then {
