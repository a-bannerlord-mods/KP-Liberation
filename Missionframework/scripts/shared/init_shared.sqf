...
add_helo_actions = compile preprocessFileLineNumbers "scripts\client\group_halo\add_helo_actions.sqf";
...
remote_call_qualifications_updated = compile preprocessFileLineNumbers "scripts\client\remotecall\remote_call_qualifications_updated.sqf";
