            ...
            ["<t color='#FFFF00'>", "-- Add to Transport Support Group", "</t>"] joinstring "",
            {
                ...
                if (_cost<_supplies) then {
                    ...
                    if (_result) then {
                        ...
                        createVehicleCrew cursorObject;
                        [cursorObject,"",-1,{},blufor_cas_support_required_items,{player getUnitTrait 'JTAC'}]  call sss_support_fnc_addtransport;
                    };

                } else {
                    Hint "Not Enough Supplies"
                };
            ...
            ["<t color='#FFFF00'>", "-- Add to CAS Support Group", "</t>"] joinstring "",
            {
                ...
                if (_cost<_supplies) then {
                    ...
                    if (_result) then {
                        ...
                        createVehicleCrew cursorObject;
                        [cursorObject,"",-1,{},blufor_cas_support_required_items,{player getUnitTrait 'JTAC'}] call sss_support_fnc_addcashelicopter;
                    };
