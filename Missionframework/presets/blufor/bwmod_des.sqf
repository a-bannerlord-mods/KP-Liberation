...
KP_liberation_boat_classname = "B_Bat_Transport_01_F";                  // These are the boats which spawn at the stern of the Freedom.
...
support_vehicles = [
    [KP_liberation_loadoutbox_classname,100,200,0],
