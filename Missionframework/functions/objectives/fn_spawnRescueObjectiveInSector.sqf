...
_grpHostage = createGroup[GRLIB_side_civilian, true];
...
if (count _cached_objectives > 0 ) then {
    ...
    _unit = [_HVT_class, _officer_pos, _grpHostage] call KPLIB_fnc_createManagedUnit;
    ...
    [_unit,_init_unit,_HVT_Name] spawn {
        ...
        _unit setVariable ["intel_value",0,true];
    };

    _unit setUnitPos "UP";
    _unit disableAI "PATH";
    [_id,[_unit],1,getPos startbase] spawn KPLIB_fnc_captureObjective;
