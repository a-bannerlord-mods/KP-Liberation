...
[{!isNull player}, {
    ...
    _action = ["GRAD_leaveNotes_mainStoreAction", "Store note", GRAD_leaveNotes_moduleRoot + "\data\give.paa", {
        
    }, {(player getVariable ["GRAD_leaveNotes_notesInInventory", 0]) > 0}] call ace_interact_menu_fnc_createAction;
    ["Land_PortableCabinet_01_bookcase_black_F",0,["ACE_MainActions"],_action,true] call ace_interact_menu_fnc_addActionToClass;
